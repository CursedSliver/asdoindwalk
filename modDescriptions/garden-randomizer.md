...
1. create a save with 0 sugar lumps, 1 sextillion cookies, 300 farms, and an empty garden with no seeds unlocked except for Baker's Wheat; if you are reusing an old save make sure to ascend once to get a new game seed. What the mutations end up becoming depends entirely on the game seed. You can use this tool to do this: [https://coderpatsy.bitbucket.io/cookies/editor.html]
...
Here is an example sheet for four players: [https://docs.google.com/spreadsheets/d/1VgnuLgKbUhH7WtJsZl2rgbjVTuXkJ5ZWFm0LbvTN4aw/edit?usp=sharing]
